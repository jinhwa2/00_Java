...
// 강아지가 동물에서 소리를 상속  //예약어는 정해진걸 쓰는 거기때문에 상속이라는 영어밖에 쓸수 밖에 없다!
public class 강아지 extends 동물 {
	...
	@Override : 부모 클래스에서 부모가 가진 메서드를 다시 작성하거나 수정해서 정의내릴 때 사용
				...
				부모 클래스에서 가지고 와서 수정했따는 개발자적 표시를 해주는 것
				
	
	//강아지 소리
	//@Override>부모님이 가지고 있는걸 가지고와서 변경했어요
	
	 */
	public void 소리() {
		System.out.println(이름 + "이(가)가 멍멍짖습니다.");
	}
