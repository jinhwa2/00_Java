...
Calendar : 날짜와 시간을 조작하는데 사용하는 추상클래스
...
public class DateEx {
	public static void main(String[] args) {
		...
		/*
		 4.SimpleDateFormat  년 월 일  - 많이 쓰인다고/중요한 아래 형식 중요함,데이터베이스할때 한번 더봄
		 년 : y  year
		...
		SimpleDateFormat 날짜형식 = new SimpleDateFormat("yyyy-MM-dd");
				String 날짜표기 = 날짜형식.format(new Date());
				System.out.println("날짜형식 지정해서 표시하기: "+날짜표기);
